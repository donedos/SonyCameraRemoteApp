...
/**
 * @ClassName：
 * @Description：TODO-A parser class for Liveview data Packet defined by Camera Remote API
 * @author：SleepyzzZ on 2016/3/24 17:00
 * @
 * @
 * @update：Administrator on 2016/3/24 17:00
 * @modify：
 */
public class LiveviewSlicer {

    private static final String TAG = LiveviewSlicer.class.getSimpleName();
