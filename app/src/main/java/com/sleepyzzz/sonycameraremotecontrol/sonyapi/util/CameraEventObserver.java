...
/**
 * @ClassName：
 * @Description：TODO-A simple observer class for some status values in Camera. This class supports
 * only a few of values of getEvent result, so please add implementation for the
 * rest of values you want to handle.
 * @author：SleepyzzZ on 2016/3/24 17:03
 * @
 * @
 * @update：Administrator on 2016/3/24 17:03
 * @modify：
 */
