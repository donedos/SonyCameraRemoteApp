 ...
 * @author：SleepyzzZ on 2016/3/24 16:53
 * @
 * @
 * @update：Administrator on 2016/3/24 16:53
 * @modify：
 */
public class RemoteApiHelper {
     ...
     *             Exception.
     */
    public static JSONObject getContentDateList(RemoteApi mRemoteApi) throws IOException {

        try {
            List<String> uri = getSupportedStorages(mRemoteApi);
            ...
            replyJson = mRemoteApi.getContentList(params);
            return replyJson;
    ...
    getContentListOfDay(RemoteApi simpleRemoteApi, String uri) throws IOException {
