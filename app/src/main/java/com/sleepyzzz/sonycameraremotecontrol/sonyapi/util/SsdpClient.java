...
/**
 * @ClassName：
 * @Description：TODO-A SSDP client class for this sample application. This implementation keeps
 * simple so that many developers understand quickly.
 * @author：Administrator on 2016/3/24 17:08
 * @
 * @
 * @update：Administrator on 2016/3/24 17:08
 * @modify：
 */
